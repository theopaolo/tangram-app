...
<div
	class="title text-title inf-bold fixed top-5 left-5 z-10 mx-auto w-fit w-max border bg-white px-[14px] py-1 tracking-[4%] drop-shadow-[var(--my-drop-shadow)]"
>
	CHROMOGRAM #1
</div>
<div class="text-inter inf-bold fixed top-2 right-5 z-10">?</div>

<div class="fixed top-3 right-13 z-10">
	<img src="/images/quoi.svg" alt="camera" class="" />
</div>

<div
	class="bloc_one absolute top-0 left-0 z-100 flex h-svh w-screen flex-col items-center justify-evenly pt-[80px] pb-[80px] text-center"
>
	<div class="w-[80dvw]">
		<p>
			{#if totalFound === 0}
...
<div class="conta absolute top-[50%] left-[50%] flex h-[80dvw] w-[80dvw] -translate-[50%]">
	<div>
		<div class="piece p1">
